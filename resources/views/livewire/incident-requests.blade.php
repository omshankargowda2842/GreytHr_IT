                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (isset($incidentRequest->file_paths) &&
                                            is_string($incidentRequest->file_paths))
                                            {
                                            $fileDataArray = json_decode($incidentRequest->file_paths, true);
                                            } elseif (isset($incidentRequest->file_paths) &&
                                            is_array($incidentRequest->file_paths)) {
                                            $fileDataArray = $incidentRequest->file_paths;
                                            }
                                            ...
                                            <a href="#"
                                                wire:click.prevent="showViewEmpImage({{ $incidentRequest->id }})"
                                            ...
                                            @if (count($empFiles) > 1)
                                            <a href="#" wire:click.prevent="showViewEmpFile({{ $incidentRequest->id }})"
                                                style="text-decoration: none; color: #007BFF; font-size: 12px; text-transform: capitalize;">
                                                View Files
                                            </a>
                                            ...
                                            {{-- view file popup --}}
                                            @if ($showViewEmpImageDialog && $currentIncidentId === $incidentRequest->id)
                                            ...
                                            @if ($showViewEmpFileDialog && $currentIncidentId === $incidentRequest->id)
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8">
                                                            <!-- File input hidden -->
                                                            <input id="fileInput-{{ $incidentRequest->id }}" type="file"
                                                                wire:model="it_file_paths.{{ $incidentRequest->id }}"
                                                            ...
                                                            <div class="req-attachmentsIcon d-flex"
                                                                ...
                                                                <button class="btn btn-outline-secondary" type="button"
                                                                    ...
                                                                    onclick="document.getElementById('fileInput-{{ $incidentRequest->id }}').click();">
                                                            ...
                                                            <div wire:loading
                                                                wire:target="it_file_paths.{{ $incidentRequest->id }}"
                                                                class="mt-2">
                                                                <i class="fas fa-spinner fa-spin"></i>
                                                                Uploading...
                                                            </div>

                                                            @error('it_file_paths.' . $incidentRequest->id . '.*')
                                                            <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            // Check if $incidentRequest->it_file_paths is a string, array, or null
                                            $fileDataArray = null;

                                            if (isset($incidentRequest->it_file_paths) &&
                                            is_string($incidentRequest->it_file_paths))
                                            {
                                            $fileDataArray = json_decode($incidentRequest->it_file_paths, true);
                                            } elseif (isset($incidentRequest->it_file_paths) &&
                                            is_array($incidentRequest->it_file_paths)) {
                                            $fileDataArray = $incidentRequest->it_file_paths;
                                            }
                                            ...
                                            <div class="modal custom-modal" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog custom-modal-dialog custom-modal-dialog-centered modal-lg"
                                                    ...
                                                    <div class="modal-content custom-modal-content">
                                                        ...
                                                        <div class="modal-footer custom-modal-footer">
                                                            <button type="button" class="submit-btn"
                                                                wire:click.prevent="downloadITImages({{ $incidentRequest->id }})">Download</button>
                                                            <button type="button" class="cancel-btn1"
                                    ...
                                    <tbody>
                                        ...
                                        <tr wire:key="incident-{{ $record->id }}">
                                            ...
                                            <td>
                                                ...
                                                {{-- view file popup --}}
                                                @if ($showViewEmpImageDialog && $currentIncidentId === $record->id)
                                                <div class="modal custom-modal" tabindex="-1" role="dialog"
                                                    style="display: block;">
                                                    <div class="modal-dialog custom-modal-dialog custom-modal-dialog-centered modal-lg"
                                                        role="document">
                                                ...
                                                @if ($showViewEmpFileDialog && $currentIncidentId === $record->id)
                                                <div class="modal" tabindex="-1" role="dialog" style="display: block;">
                                                    <div class="modal-dialog modal-dialog-centered modal-md"
                                                        role="document">
                                                        <div class="modal-content">
                                                ...
                                                <div id="modalFiles" class="row service-detail-item">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <td>
                                                            ...
                                                            {{-- view file popup --}}
                                                            @if ($showViewEmpImageDialog && $currentIncidentId ===
                                                            $selectedRecord->id)
                                                            <div class="modal custom-modal" tabindex="-1" role="dialog"
                                                                style="display: block;">
                                                                <div class="modal-dialog custom-modal-dialog custom-modal-dialog-centered modal-lg"
                                                            ...
                                                            @if ($showViewEmpFileDialog && $currentIncidentId ===
                                                            $selectedRecord->id)
