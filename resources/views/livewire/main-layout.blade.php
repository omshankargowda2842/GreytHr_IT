    ...
    <div class="sidebar-overlay" data-dismiss="sidebar"></div>
            ...
            <div class="sidebar-menu-wrapper">
                <ul class="sidebar-menu">
                    <li class="sidebar-menu-item-title">
                        <span class="sidebar-menu-item-title-expanded"
                            >Menu</span
                        >
                    ...
                    <li class="sidebar-menu-item">
                        <a href="#" wire:click='dashboard' class="{{ request()->routeIs('dashboard') ? 'active-menu sidebar-menu-item-link' : 'sidebar-menu-item-link' }}">
                    ...
                    <li class="sidebar-menu-item">
                        <a href="#" class="{{ request()->routeIs('oldItMembers') || request()->routeIs('requests') || request()->routeIs('itMembers') ? 'active-menu sidebar-menu-item-link' : 'sidebar-menu-item-link' }}">
                            <span class="sidebar-menu-item-link-icon"
                        ...
                        <ul class="sidebar-submenu">
                            <li class="{{ request()->routeIs('requests') ? 'active-submenu sidebar-submenu-item' : 'sidebar-submenu-item' }}">
                                <a href="#" wire:click='itRequest' class="sidebar-submenu-item-link">
                                    <span class="sidebar-submenu-item-link-text"
                                        >IT Request</span
                                    >
                                </a>
                            </li>
                            <li class="{{ request()->routeIs('itMembers') ? 'active-submenu sidebar-submenu-item' : 'sidebar-submenu-item' }}">
                            ...
                            <li class="{{ request()->routeIs('oldItMembers') ? 'active-submenu sidebar-submenu-item' : 'sidebar-submenu-item' }}">
                    ...
                    <li class="sidebar-menu-item">
                        <a href="#" class="{{ request()->routeIs('vendor') || request()->routeIs('vendorAssets') ? 'active-menu sidebar-menu-item-link' : 'sidebar-menu-item-link' }}">
                            <span class="sidebar-menu-item-link-icon"
                        ...
                        <ul class="sidebar-submenu">
                            <li class="{{ request()->routeIs('vendor') ? 'active-submenu sidebar-submenu-item' : 'sidebar-submenu-item' }}">
                            ...
                            <li class="{{ request()->routeIs('vendorAssets') ? 'active-submenu sidebar-submenu-item' : 'sidebar-submenu-item' }}">
                    ...
                    <li class="sidebar-menu-item">
                        <a href="#" class="{{ request()->routeIs('assignAsset') ? 'active-menu sidebar-menu-item-link' : 'sidebar-menu-item-link' }}">
                            <span class="sidebar-menu-item-link-icon"
                        ...
                        <ul class="sidebar-submenu">
                            <li class="{{ request()->routeIs('assignAsset') ? 'active-submenu sidebar-submenu-item' : 'sidebar-submenu-item' }}">
                                <a href="#" wire:click='assignAsset' class="sidebar-submenu-item-link">
                                    <span class="sidebar-submenu-item-link-text"
                                        >Employee Assets</span
                                    >
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="sidebar-menu-item">
                        <a href="#" class="{{ request()->routeIs('password') ? 'active-menu sidebar-menu-item-link' : 'sidebar-menu-item-link' }}">
                            <span class="sidebar-menu-item-link-icon"
        ...
        <div class="main">
            <div class="topbar" id="customNav">
                ...
                <button
                    type="button"
                    class="topbar-button topbar-toggle"
                    data-toggle="sidebar"
                >
