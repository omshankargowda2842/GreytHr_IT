<div class="container-fluid p-0 loginBGGradiant">
    ...
    <div class="row m-0">
        ...
        <div class="col-md-5 px-5 py-2 ">
            ...
            @endif
            <form wire:submit.prevent="itLogin" class="login-form-with-shadow itlogin4"
                >
                ...
                <div class="form-group itlogin6">
                    <input type="password" class="form-control border-0 border-bottom itloginInput" placeholder="Password"
                ...
                <div class="form-group itlogin9" >
                    <input data-bs-toggle="modal" data-bs-target="#loginLoader"
                     type="submit"
                        class="btn btn-primary btn-block itloginInput1" value="Login" />
                </div>
            </form>
        </div>
        <div class="text-center pb-2">
            <small>
                ...
                <a href="https://xsilicasoftwaresolutions.greythr.com/v2/static-content/privacy-policy" class="itlogin10" target="_blank"
                  >Privacy Policy</a> |
                <a href="https://xsilicasoftwaresolutions.greythr.com/v2/static-content/terms-of-use" class="itlogin10" target="_blank"
                >Terms of Service</a>
            </small>
        </div>
