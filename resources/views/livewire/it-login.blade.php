                ...
                <form class="form" wire:submit.prevent="itLogin" wire:key="empLogin-{{ $resetKey }}">
                    ...
                    <div class="input-block">
                        ...
                        <div class="input-group" style="align-items: center;">
                            ...
                            @if ($showEyeIcon)
                                <span
                                    style="background-color: #fff; height:42px;top: 10px;right: 17.5%;"class="input-group-text pointer position-absolute"
        ...
        <div class="text-center pb-2">
            <small>
                ...
                <a href="https://xsilicasoftwaresolutions.greythr.com/v2/static-content/terms-of-use"
                    class="itlogin10" target="_blank">Terms of Service</a>
            </small>
        </div>
    </div>
