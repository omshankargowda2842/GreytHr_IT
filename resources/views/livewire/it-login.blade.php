    ...
    <div class="row m-0">
            ...
            <div class="left">
                ...
                <form class="form" wire:submit.prevent="itLogin">
                    ...
                    <div class="input-block">
                        ...
                        <button class="button-login" data-bs-toggle="modal" data-bs-target="#loginLoader" type='submit'>Submit</button>
                    </div>
                </form>
            </div>
            <div class="right">
        ...
        <div class="text-center pb-2">
            <small>
                ...
                <a href="https://xsilicasoftwaresolutions.greythr.com/v2/static-content/privacy-policy" class="itlogin10" target="_blank">Privacy Policy</a> |
                <a href="https://xsilicasoftwaresolutions.greythr.com/v2/static-content/terms-of-use" class="itlogin10" target="_blank">Terms of Service</a>
            </small>
        </div>
    </div>
