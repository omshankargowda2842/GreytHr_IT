...
<div class="email-container">
       ...
       <hr class="hor-line">
        ...
        <div class="email-body">
            ...
            <p class="sub-heading"><strong>{{ $requestId }} </strong> has been cancel for the following reason.</p>
            <p class="sub-heading">Cancelled By : <strong>{{  ucwords(strtolower($rejectedEmpName))}}</strong></p>
