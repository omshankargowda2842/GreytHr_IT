...
<body>
    <div class="email-container">
        <!-- Header -->
        <div class="header">
            Request was approved by {{ucwords(strtolower($superAdmin))}}
        </div>
        <hr class="hor-line">
        <!-- Body -->
        ...
        <p class="sub-heading">Request <strong>{{ $requestId }}</strong> has been successfully approved.</p>
        <h3>Details of Approval</h3>
            ...
            <p class="sub-heading">Approved By : <strong>{{ ucwords(strtolower($superAdmin)) }}</strong></p>
